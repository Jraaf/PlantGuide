...
[ApiController]
public class SourcePlantController(ISourcePlantService _service) : ControllerBase
{
    [HttpGet("GetAll")]
    ...
    [HttpPost("add")]
    public async Task<IActionResult> Post(CreateSourcePlantDTO model)
    {
    ...
    [HttpPut("Update")]
    public async Task<IActionResult> Update(int id, CreateSourcePlantDTO DTO)
    {
